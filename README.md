...
```
# Baidu Analytics
ba_track_id: 456cee4a16093ac54c79fdb531axxxxx

# Google Analytics
ga_track_id: 'UA-xxxxxxxxx-1'            # 你用Google账号去注册一个就会给你一个这样的id
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/fengdis/fengdis.github.io/blob/master/LICENSE)。
